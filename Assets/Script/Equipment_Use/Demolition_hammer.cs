...
{
    public GameObject _demolition_hammer_Attack; //鑿破機攻擊prefab物件
    public void Attack(GameObject player, int teamNum)
    {
        ...
        {
            GameObject p_attack = Instantiate(_demolition_hammer_Attack, Mining_area_under_the_player.transform.position, player.transform.rotation); //生成打樁機攻擊物件
